...
function search() {
  ...
  if (foundReservation) {
    ...
    footer.textContent = `Le client ${foundReservation.firstname} ${foundReservation.lastname} doit régler la somme de : ${totalPrice} euros.`;
    console.log("Réservation trouvée", foundReservation);
  } else {
    footer.textContent = `Aucune réservation trouvée pour le client : ${searchlastname} ${searchfirstname}.`;
  }
